...
class ReportController extends Controller
{
    ...
    public function SearchByDate(Request $request){
        ...
        return view('admin.backend.report.report_by_date',compact('formatDate','payment'));
    ...
    public function SearchByMonth(Request $request){
        ...
        return view('admin.backend.report.report_by_month',compact('month','year','payment'));
    ...
    public function SearchByYear(Request $request){
        ...
        return view('admin.backend.report.report_by_year',compact('year','payment'));
