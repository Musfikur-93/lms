        ...
        <div class="card-body p-4">
            <form action="{{ route('update.blog.post') }}" method="post" id="myForm" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="long_descp" class="form-control" id="summernote">{!! $post->long_descp !!}</textarea>
                </div>
                ...
                <div class="col-md-6">
                    <img id="showImage" src="{{ asset($post->post_image) }}" alt="image" class="rounded-circle p-1 bg-primary" width="80">
                </div>
