                    ...
                    <div class="card-body">
                        ...
                        <div class="divider"><span></span></div>
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control" type="text" name="phone" value="{{ Auth::user()->phone }}">
                        ...
                        <div class="order-details-lists">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-3 mb-3">
                                <a href="{{ url('course/details/'.$item->id.'/'.$item->options->slug) }}" class="media-img">
                                    <img src="{{ asset($item->options->image) }}" alt="Cart image" style="width:80px; height:80px;">
                                </a>
