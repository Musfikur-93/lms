                                        ...
                                        <div class="lecture-overview-stats-wrap d-flex">
                                            ...
                                            <div class="lecture-overview-stats-item">
                                                <ul class="generic-list-item">
                                                    ...
                                                    <li><span>Languages:</span>English|Bengali</li>
                                    ...
                                    <div class="lecture-overview-item">
                                        <div class="lecture-overview-stats-wrap d-flex">
                                            ...
                                            <div class="lecture-overview-stats-item lecture-overview-stats-wide-item">
                                                <p class="pb-3">Get certificate by completing entire course</p>
                                    ...
                                    <div class="lecture-overview-item">
                                        <div class="lecture-overview-stats-wrap d-flex">
                                            ...
                                            <div class="lecture-overview-stats-item lecture-overview-stats-wide-item lecture-description">
                                                <h3 class="fs-16 font-weight-semi-bold pb-2">From the Author of the {{ $course->course->course_name }} Course </h3>
                                            ...
                                            <div class="lecture-overview-stats-item lecture-overview-stats-wide-item">
                                                <div class="media media-card align-items-center">
                                                    <a href="teacher-detail.html" class="media-img d-block rounded-full avatar-md">
                                                        <img src="{{ (!empty($course->instructor->photo)) ? url('upload/instructor_images/'.$course->instructor->photo) : url('upload/no_image.jpg') }}" alt="Instructor avatar" class="rounded-full">
                                                    </a>
                                                    <div class="media-body">
                                                        <h5><a href="teacher-detail.html">{{ $course->instructor->name }}</a></h5>
                                                        <span class="d-block lh-18 pt-2">{{ $course->instructor->email }}</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="lecture-overview-wrap lecture-quest-wrap">
                                    ...
                                    <div class="question-overview-result-wrap">
                                        ...
                                        <div class="lecture-overview-item mt-0">
                                            ...
                                            @php
                                                $id = Auth::user()->id;
                                                $question = App\Models\Question::where('user_id',$id)->where('course_id',$course->course->id)->where('parent_id',null)->orderBy('id','desc')->get();
                                            @endphp
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="curriculum-sidebar-list">
                                            ...
                                            <li class="course-item-link active">
                                                <div class="course-item-content-wrap">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="courseCheckbox">
