        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                ...
                <div class="d-flex flex-wrap align-items-center pt-3">
                    ...
                    @else
                        <h6 class="ribbon ribbon-lg mr-2 bg-3 text-white">New</h6>
                    @endif
               ...
               <div class="course-details-content-wrap pt-90px">
                           ...
                           <div class="media media-card align-items-center">
                            ...
                            <div class="media-body">
                                ...
                                @php
                                    ...
                                    $percentages = [];
                                    for ($i=5; $i >= 1 ; $i--) {
                                        $ratingCount = $reviewcount->where('review',$i)->first();
                                ...
                                @endphp
                                    ...
                                    <div class="review-bars d-flex align-items-center mb-2">
                                        <div class="review-bars__text">{{ $ratingInfo['review'] }} stars</div>
                   ...
                   <div class="course-overview-card pt-4">
                       ...
                       <div class="review-wrap">
                        ...
                        @php
                            $review = App\Models\Review::where('course_id',$course->id)->where('status',1)->latest()->limit(5)->get();
                        @endphp
                   ...
                   @guest
                        <p><b>For Add Review. You need to login first. <a href="{{ route('login') }}">Login Here</a></b></p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="buy-course-btn-box">
                                    ...
                                    {{-- start instructor coupon section --}}
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                ...
                <div class="card card-item">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a href="{{ url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug) }}">{{ Str::limit($inscourse->course_name,40) }}</a></h5>
                        <p class="card-text"><a href=" ">{{ $inscourse['user']['name'] }}</a></p>
