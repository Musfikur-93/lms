...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('update.course') }}" method="post" id="myForm" class="row g-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="certificate" class="form-select mb-3" aria-label="Default select example">
                        <option selected="" disabled>certificate available</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="feartured" value="1" id="flexCheckDefault" {{ $course->feartured == '1' ? 'checked' : '' }}>
        ...
        <div class="card-body">
            <form action="{{ route('update.course.image') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img id="showImage" src="{{ asset($course->course_image) }}" alt="image" class="rounded-circle p-1 bg-primary" width="100">
                    </div>
                </div>
                <br>
                <div class="col-md-12">
        ...
        <div class="card-body">
            <form action="{{ route('update.course.video') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <video src="{{ asset($course->video) }}" width="300" height="130" type="video/mp4" controls></video>
                    </div>
                </div>
                <br>
                <div class="col-md-12">
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                certificate: {
                    required : 'Please Enter Certificate Availabilities',
                },

                label: {
                    required : 'Please Enter course Label',
                },
